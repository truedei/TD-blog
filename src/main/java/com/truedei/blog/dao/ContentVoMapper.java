...
public interface ContentVoMapper {
    ...
    ////////////////新的
    List<Map<String,Object>> selectRecentContents(@Param("pageBean")PageBean<Map<String, Object>> pageBean);

    Long countContents();

    List<ContentVo> getContentsList(PageBean<Map> pageBean, Map<String, Object> pmap);
