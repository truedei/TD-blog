...
import com.truedei.blog.modal.vo.*;
import org.apache.commons.lang3.StringUtils;
import org.springframework.stereotype.Service;
import com.truedei.blog.dao.AttachVoMapper;
import com.truedei.blog.dao.CommentVoMapper;
import com.truedei.blog.dao.ContentVoMapper;
import com.truedei.blog.dao.MetaVoMapper;
...
import com.truedei.blog.util.ZipUtils;
import com.truedei.blog.util.backup.Backup;
...
public class SiteServiceImpl implements ISiteService {
     ...
     */
    @Override
    public List<Map<String,Object>> selectRecentContents(PageBean<Map<String, Object>> pageBean) {
        pageBean.setOrderBy("created");
        pageBean.setOrderType(PageBean.OrderType.desc);

        return contentDao.selectRecentContents(pageBean);
    }
     ...
     */
    @Override
    public List<Map<String, Object>> selectRecentComments(PageBean<Map<String, Object>> pageBean) {
        pageBean.setOrderBy("created");
        pageBean.setOrderType(PageBean.OrderType.desc);

        return commentDao.selectRecentComments(pageBean);
    }
    ...
    public Map<String, Object> getSiteData() {
        ...
        Long articles = contentDao.countContents();
        Long comments = commentDao.countComments();
        Long attachs = attachDao.countAttachs();
        Long links = metaDao.countLinks();

        result.put("articles",articles);
        result.put("comments",comments);
        result.put("attachs",attachs);
