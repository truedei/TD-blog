...
import com.truedei.blog.service.IRelationshipService;
...
import com.truedei.blog.modal.redisKey.ContentKey;
...
import com.truedei.blog.util.RedisKeyUtil;
import com.truedei.blog.util.Tools;
...
//        Object contentObject = valueOperations.get(contentKey);
        if (contentVo == null){
...
//        else{
//            contentVo = (ContentVo)contentObject;
//        }
        return contentVo;
    }
    ...
    @Override
    public PageInfo<ContentVo> getContentsList(PageBean<Map> pageBean, Map<String, Object> pmap) {
        PageHelper.startPage(pageBean.getPageNumber(), pageBean.getPageSize());
//        List<ContentVo> contentVos = contentDao.selectByExampleWithBLOBs(commentVoExample);
        List<ContentVo> contentList = contentDao.getContentsList(pageBean,pmap);
