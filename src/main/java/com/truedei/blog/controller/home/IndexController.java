package com.truedei.blog.controller.home;
...
import com.truedei.blog.service.*;
...
import com.truedei.blog.modal.bo.CommentBo;
...
import com.truedei.blog.util.IpUtil;
import com.truedei.blog.util.MyUtils;
import com.truedei.blog.util.PatternKit;
...
public class IndexController extends AbstractController {
    ...
    private String index(HttpServletRequest request, @RequestParam(value = "limit", defaultValue = "10") int limit) {
        return this.index(request, 1,null, limit);
    }
     ...
     * @return
     */
    @GetMapping(value = {"page/{select}/{p}"})
    public String index(HttpServletRequest request,
        ...
        if(select!=null && !select.equals("default")){
            String requestURI = request.getRequestURI();
            requestURI=requestURI.substring(1,requestURI.lastIndexOf("/"));
            request.setAttribute("requestURI",requestURI);
        }else{
            request.setAttribute("requestURI","page/default");
        }
    ...
    public String about(HttpServletRequest request) {
        List<MetaVo> links = metaService.getMetas(Types.LINK.getType());
        request.setAttribute("about", links);
